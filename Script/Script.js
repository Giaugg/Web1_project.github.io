...
>>>>>>> parent of 60bb356 (Merge branch 'main' of https://github.com/Giaugg/Web1_project.github.io)
         })
...
// // Form Login & Register
      ...
      options.rules.forEach( function (rule){
          ...
          if (inputElement1){
              ...
              inputElement1.oninput= function(){
                  var errorElement= inputElement1.parentElement.querySelector('.form-message');
                  errorElement.innerText ='';
      ...
      options.rules.forEach( function (rule){
          ...
          if (inputElement2){
              ...
              inputElement2.oninput= function(){
                  var errorElement= inputElement2.parentElement.querySelector('.form-message');
                  errorElement.innerText ='';
  ...
  Validator.isPhoneNumber = function(selector) {
      return {
          selector: selector,
          test: function(value) {
              return /^[0-9]{10}$/.test(value) ? undefined : 'Please enter a valid phone number';
          }
      };
  };
  ...
  Validator.isMinlength = function(selector, min) {
      return {
          selector: selector,
          test: function(value) {
              return value.length>=min ? undefined : 'Password must contain at least  '+min+' characters.';
          }
      };
  };
